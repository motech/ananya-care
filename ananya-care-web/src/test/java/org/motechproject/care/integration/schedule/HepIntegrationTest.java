...
public class HepIntegrationTest extends SpringIntegrationTest {
    ...
    public void shouldVerifyHep1ScheduleFulfillmentWhenHep1VaccinationIsTaken() {
        ...
        assertEquals(DateUtil.newDateTime(hep1Date.plusWeeks(4)), enrollment.getStartOfDueWindow().withTimeAtStartOfDay());
        assertEquals(DateUtil.newDateTime(hep1Date.plusMonths(24)), enrollment.getStartOfLateWindow().withTimeAtStartOfDay());
    }
    ...
    public void shouldVerifyHep2ScheduleFulfillmentWhenHep2VaccinationIsTaken() {
        ...
        assertEquals(DateUtil.newDateTime(hep2Date.plusWeeks(4)), enrollment.getStartOfDueWindow().withTimeAtStartOfDay());
        assertEquals(DateUtil.newDateTime(hep2Date.plusMonths(24)), enrollment.getStartOfLateWindow().withTimeAtStartOfDay().withTimeAtStartOfDay());
    }
